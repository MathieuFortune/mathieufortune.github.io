...
<div class="text-center">
  <a href="/resume/" class="btn--default btn--medium">View my Resume</a>&nbsp;&nbsp;&nbsp;
  <a href="https://www.loom.com/share/fdd817d7b28d4a258156fbcaef7f4bdf?sid=9a6de288-7eaf-4f2f-bd26-09796bf43a56" target="_blank" class="btn--default btn--medium">Get to know me</a>&nbsp;&nbsp;&nbsp;
  <a href="mailto:pro.mathieu.fortune@gmail.com?subject=Hello I want to hire you !&amp;body=Hi Mathieu, I was looking to hire someone like you for..." class="btn--default btn--medium">Hire me</a>
</div>
...
These values are the foundation of my work philosophy, guiding every decision I make. I partner with organizations and teams that share a commitment to these principles, leading to impactful and meaningful outcomes.

**Open Collaboration and Transparency**: My approach to product development and design is rooted in open collaboration and transparency. By engaging in open dialogue, sharing insights, and maintaining clear communication, I create an environment where ideas can flow freely. This transparency not only builds trust but also aligns teams toward common goals, fostering a collaborative and effective work environment.

**Positive Impact and Well-being**: At the heart of my work is the pursuit of solutions that prioritize the well-being of individuals and communities. I strive to create products that not only meet business objectives but also contribute positively to society. My focus is on designing inclusive and empathetic solutions that promote societal betterment and bring about lasting positive changes.

**Intellectual Honesty**: I approach challenges with an open mind and a willingness to recognize and learn from knowledge gaps. This intellectual honesty is not just about finding immediate solutions but about gaining a deeper understanding of each project's nuances. Sharing this value with my team cultivates a culture of growth, learning, and mutual respect.

Together, these values shape my approach to product management and design, ensuring that every project I undertake is both meaningful and impactful.

<h3 class="joker-fs"><div class="title-sub--over">Experiences</div>With more than a decade of experience, I have:</h3>

- **Collaborated with climate scientists and sustainability experts** to transform complex carbon management problems into easy-to-use solutions.

- **Led the design overhaul of a SaaS platform** for an Ed-Tech startup serving over 2M users across 180+ higher-ed institutions in the U.S.

- **Spearheaded the development and maintenance of a design system** used by 30+ team members, streamlining processes and enhancing collaboration.

- **Co-founded an Ed-Tech startup**, empowering 50,000 students and generating six-figure revenue within three years, embodying a founder mindset that I carry into every project.

- **Worked directly with clients in agencies**, defining product scopes, goals, user assumptions, and pain points to deliver user-centric solutions.

- **Led product feature design** for a multi-million dollar e-commerce marketplace, driving key business outcomes.

- **Developed fast, responsive websites** using HTML5, CSS, JavaScript, and Agile methodologies, ensuring seamless user experiences.

- **Designed intuitive user interfaces**, sketches, and prototypes for websites and mobile applications, balancing aesthetics with functionality.

- **Conducted user research** with a design thinking and lean approach, aligning products with user needs and market demands.

- **Launched numerous marketing campaigns** that generated customer loyalty and revenue growth, driving business success.
...
<div class="text-center">
  <a href="/resume/" title="Mathieu Fortune Resume" class="btn--default btn--medium">View my Resume</a>&nbsp;&nbsp;&nbsp;
...
I had the pleasure of managing Mathieu during his time at Carbon Direct. Throughout our collaboration, he consistently proved himself through his quick grasp of complex industry concepts, thoughtful problem-solving approach, and the in-depth work he produced. Upon joining, he quickly immersed himself in the carbon management industry, showcasing dedication to understanding our unique challenges through continuous internal and external learning. His strong sense of curiosity and analytical thinking shone through in his work, as he skillfully handled project complexities while excelling in facilitating cross-functional collaboration.<br/>
<br/>
In his role, he created impactful artifacts that improved our design processes and cross-team communication. Whether leading design workshops or conducting customer insight audits, he consistently delivered valuable outputs and enhanced the team's approach to customer engagement. An accomplished designer with a keen eye for detail and a broad range of experience, Mathieu can effectively engage at any level of the design process. He would undoubtedly be an asset to any team that has the opportunity to work with him.
<p class="text-right bold">Darren E. - Product Design Manager/Leader @ Carbon Direct</p>
</blockquote>

<blockquote class="small" style="max-width: 100%; margin: 16px;">
Don't wait on the chance to add Mathieu Fortune to your team!<br/>
I had the pleasure to work alongside Mathieu at Mentor Collective for nearly 3 years -- Me in the role of Senior Product Manager, and him in the role of Senior Product Designer. When running a product squad, a designer can really make or break a team's flow, and I can say without a doubt that Mathieu was always a key player in allowing us to ship high-quality product work, quickly! He has a gift for being able to envision the big picture (think 1-5year plan), and also be able to work with the team to break that work out iteratively, so we can be continuously shipping, learning, and improving.<br/><br/>
One of the ways Mathieu accomplished this while I worked with him, was by building out a reliable design system that not only supported our current product, but was able to grow and evolve as the product grew and evolved. The roll-out of this update was smooth and easy for the whole team to understand. <br/>
Additionally, Mathieu's documentation is pristine. In fact, on one occasion while I was reviewing Mathieu's Figma designs, my husband (a VP of Product at a startup) looked over my shoulder and said, "Whoa, did your designer do that?! I've never seen such an organized Figma file!" For Mathieu, design work doesn't stop at building out a UX/UI that solves the user problem -- He follows through to make sure he communicates this design to the development team to turn the ideas into a reality. Clear layers, research documentation, handoff notes, and a background in frontend engineering make Mathieu a dream designer for engineers. I lost count of the number of sprint retros where the engineers sang his praises.<br/>
<br/>
...
<p class="text-right bold">Kelley J. - Senior Product Manager @ Mentor Collective</p>
</blockquote>
...
<p class="text-right bold">Prakhar A. - Sr. Product Manager @ Carbon Direct</p>
</blockquote>

<blockquote class="small col-half--right">I had the privilege of working with Mathieu at Carbon Direct, where he served as the Senior Product Designer of our cross-functional product development team. Mathieu is an exceptional designer who effectively navigated the complexities of our team’s software development in the context of a fast-moving organization while building our carbon accounting platform.
Mathieu's technical knowledge allows him to communicate effectively with engineers, and he knows when to push technical or user experience boundaries and when to follow engineering recommendations, ensuring that products remain at the cutting edge of innovation.
Mathieu is also a fantastic collaborator who constantly seeks the insights of his partners from other functions. He ensures that hand-off processes are clear and smooth for his team, making projects more efficient, well-understood, and successful.
I highly recommend Mathieu for any team looking for a talented and technically savvy designer. He is an invaluable asset and a pleasure to work with.
<p class="text-right bold">Mat G. - Engineering Manager @ Carbon Direct</p>
</blockquote>
...
<p class="text-right bold">Stephen M. - VP of Product @ Mentor Collective</p>
</blockquote>
...
<p class="text-right bold">Abbie M. - Product Designer @ Mentor Collective</p>
</blockquote>
...
<p class="text-right bold">Amma M. - UX Writer @ Mentor Collective</p>
</blockquote>
...
<p class="text-right bold">Shannon L. - Principal Product Manager @ Mentor Collective</p>
</blockquote>
...
<p class="text-right bold">Kervin V. - Software Engineer @ Mentor Collective</p>
</blockquote>
...
<p class="text-right bold">Lindsay W. - Senior Software Engineer @ Mentor Collective</p>
</blockquote>
...
<p class="text-right bold">Jennifer K., Product Manager @ Mentor Collective</p>
</blockquote>
...
<p class="text-right bold">Solène Paillet, Marketing Director French Division @ Gleeden</p>
</blockquote>
...
<p class="text-right bold">Cass P. - Software Engineer @ Mentor Collective</p>
</blockquote>
...
<p class="text-right bold">Tatiana D., Senior Sales Operative Manager @ Bakerly</p>
</blockquote>
...
<p class="text-right bold">Cliff Grente, Software Developer @ Gleeden</p>
</blockquote>
...
<p class="text-right bold">Jordan Cohen, CEO @ MaintenanceQuebec</p>
</blockquote>
...
<p class="text-right bold">Cédric O'Neill, co-founder and former CEO @ 1001pharmacies.com</p>
</blockquote>
...
Working with Mathieu on UX subjects was very exciting... He's always learning about topics around user-centered design and doesn't hesitate to challenge project ideas to move forward. Also, he has a real eye for aesthetics! I can only recommend you to work with Mathieu.
  <p class="text-right bold">Audrey Lambert, former digital marketing manager @ 1001pharmacies.com</p>
</blockquote>
...
Thanks to his exceptional design skills and clear explanations in projects (whose collaboration was rich in learning/teaching and very rewarding), he did them by providing much value to the different projects. Motivated and passionate, he helped me and other colleagues to improve themselves. It's a pleasure to work with him, and I recommend him for future web projects.
  <p class="text-right bold">Sébastien Correaud, former front-end developer @ 1001pharmacies.com</p>
</blockquote>
...
<blockquote class="small col-third">
  ...
  <p class="text-right bold">Guilhem Marty, former CTO @ 1001pharmacies.com</p>
</blockquote>
