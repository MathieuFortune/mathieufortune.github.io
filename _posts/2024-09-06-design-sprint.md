...
<div class="cs-grid wide">
  ...
  {% include callout.html variant="compact" text="Leadership pressure for quick results to reassure stakeholders" %}
  {% include callout.html variant="compact" text="Team's limited knowledge of the complex carbon management domain" %}
  {% include callout.html variant="compact" text="Uncertainty about when customers encounter decarbonization needs" %}
  {% include callout.html variant="compact" text="Limited team resources, with expansion contingent on uncovering opportunities" %}
...
<div class="testimonials wide">
  ...
  {% include testimonial.html quote="Mathieu's expertise really shone through during the design sprint. It was not only a chance for us to create a solid roadmap but also to build strong connections within our newly formed team and with cross-functional colleagues. I'm excited to be working with you, Mathieu!" author="Jasper C., Senior Software Engineer" %}
